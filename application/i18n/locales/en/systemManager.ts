...
export const enSystemManagerMessages: Messages = {
  ...
  'systemManager.errors.loadZellij': 'Failed to load zellij sessions',
  'systemManager.errors.loadZellijDetails': 'Failed to load zellij tabs',
  'systemManager.errors.actionFailed': 'Action failed',
  'systemManager.errors.openManagedTerminalUnavailable': 'Unable to open terminal in a new tab',
  ...
  'systemManager.tmux.new': 'New tmux',
  ...
  'systemManager.zellij.new': 'New zellij',
  'systemManager.zellij.search': 'Search zellij sessions…',
  'systemManager.zellij.empty': 'No zellij sessions',
  'systemManager.zellij.unavailable': 'zellij is not available on this host',
  'systemManager.zellij.meta': '{{count}} session(s)',
  'systemManager.zellij.newSessionTitle': 'New zellij session',
  'systemManager.zellij.newSessionDesc': 'Name the session and create it in the background.',
  'systemManager.zellij.newSessionName': 'Session name',
  'systemManager.zellij.newSessionPlaceholder': 'my-session',
  'systemManager.zellij.newSessionRequired': 'Enter a session name first',
  ...
  'systemManager.zellij.rename': 'Rename',
  ...
  'systemManager.zellij.tabList': 'Tabs',
  'systemManager.zellij.tabName': 'Tab name',
  'systemManager.zellij.newTab': 'New tab',
