...
export const enVaultMessages: Messages = {
  ...
  'pf.action.releaseRemotePort': 'Release Remote Port and Start',
  'pf.release.remoteConfirmTitle': 'Release stale remote tunnel',
  'pf.release.remoteConfirmDesc': 'This will connect to the SSH server, terminate the old sshd child still holding remote port {port} for "{label}", then start the tunnel again.',
  'pf.release.remoteConfirmAction': 'Release and Start',
