...
export const esSystemManagerMessages: Messages = {
  ...
  'systemManager.errors.loadZellij': 'No se pudieron cargar las sesiones de zellij',
  'systemManager.errors.loadZellijDetails': 'No se pudieron cargar las pestañas de zellij',
  ...
  'systemManager.zellij.new': 'Nueva zellij',
  'systemManager.zellij.search': 'Buscar sesiones de zellij…',
  'systemManager.zellij.empty': 'No hay sesiones de zellij',
  'systemManager.zellij.unavailable': 'zellij no está disponible en este host',
  'systemManager.zellij.meta': '{{count}} sesión(es)',
  'systemManager.zellij.newSessionTitle': 'Nueva sesión de zellij',
  'systemManager.zellij.newSessionDesc': 'Ponle nombre a la sesión y créala en segundo plano.',
  'systemManager.zellij.newSessionName': 'Nombre de la sesión',
  'systemManager.zellij.newSessionPlaceholder': 'mi-sesion',
  'systemManager.zellij.newSessionRequired': 'Primero escribe un nombre de sesión',
  ...
  'systemManager.zellij.rename': 'Renombrar',
  ...
  'systemManager.zellij.tabList': 'Pestañas',
  'systemManager.zellij.tabName': 'Nombre de la pestaña',
  'systemManager.zellij.newTab': 'Nueva pestaña',
