...
export const ruSystemManagerMessages: Messages = {
  ...
  'systemManager.tabs.zellij': 'zellij',
  ...
  'systemManager.errors.loadZellij': 'Не удалось загрузить сессии zellij',
  'systemManager.errors.loadZellijDetails': 'Не удалось загрузить вкладки zellij',
  'systemManager.errors.actionFailed': 'Не удалось выполнить действие',
  'systemManager.errors.openManagedTerminalUnavailable': 'Не удалось открыть терминал в новой вкладке',
  ...
  'systemManager.tmux.new': 'Создать tmux',
  ...
  'systemManager.zellij.new': 'Создать zellij',
  'systemManager.zellij.search': 'Поиск сессий zellij…',
  'systemManager.zellij.empty': 'Нет сессий zellij',
  'systemManager.zellij.unavailable': 'zellij недоступен на этом хосте',
  'systemManager.zellij.meta': '{{count}} сессий',
  'systemManager.zellij.newSessionTitle': 'Новая сессия zellij',
  'systemManager.zellij.newSessionDesc': 'Задайте имя сессии и создайте её в фоне.',
  'systemManager.zellij.newSessionName': 'Имя сессии',
  'systemManager.zellij.newSessionPlaceholder': 'my-session',
  'systemManager.zellij.newSessionRequired': 'Сначала введите имя сессии',
  ...
  'systemManager.zellij.rename': 'Переименовать',
  ...
  'systemManager.zellij.tabList': 'Вкладки',
  'systemManager.zellij.tabName': 'Имя вкладки',
  'systemManager.zellij.newTab': 'Новая вкладка',
