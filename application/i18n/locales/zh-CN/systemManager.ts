...
export const zhCnSystemManagerMessages: Messages = {
  ...
  'systemManager.errors.loadZellij': '加载 zellij 会话失败',
  'systemManager.errors.loadZellijDetails': '加载 zellij 标签页失败',
  'systemManager.errors.actionFailed': '操作失败',
  'systemManager.errors.openManagedTerminalUnavailable': '无法在新标签页打开终端',
  ...
  'systemManager.tmux.new': '新建 tmux',
  ...
  'systemManager.zellij.new': '新建 zellij',
  'systemManager.zellij.search': '搜索 zellij 会话…',
  'systemManager.zellij.empty': '没有 zellij 会话',
  'systemManager.zellij.unavailable': '此主机未检测到 zellij',
  'systemManager.zellij.meta': '{{count}} 个会话',
  'systemManager.zellij.newSessionTitle': '新建 zellij 会话',
  'systemManager.zellij.newSessionDesc': '输入会话名称，并在后台创建会话。',
  'systemManager.zellij.newSessionName': '会话名称',
  'systemManager.zellij.newSessionPlaceholder': 'my-session',
  'systemManager.zellij.newSessionRequired': '请先输入会话名称',
  ...
  'systemManager.zellij.rename': '重命名',
  ...
  'systemManager.zellij.tabList': '标签页',
  'systemManager.zellij.tabName': '标签页名称',
  'systemManager.zellij.newTab': '新建标签页',
