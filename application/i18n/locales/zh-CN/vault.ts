...
export const zhCNVaultMessages: Messages = {
  ...
  'pf.action.releaseRemotePort': '释放远端端口并启动',
  'pf.release.remoteConfirmTitle': '释放远端旧 tunnel',
  'pf.release.remoteConfirmDesc': '将连接到 SSH server，结束仍占用远端端口 {port} 的旧 sshd 子进程，然后重新启动规则“{label}”。',
  'pf.release.remoteConfirmAction': '释放并启动',
  'pf.view.grid': '网格',
  'pf.view.list': '列表',
